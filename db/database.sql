...
--
-- Name: enerprise; Type: DATABASE; Schema: -; Owner: postgres
--
DROP DATABASE enterprise;

CREATE DATABASE enterprise WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE enterprise OWNER TO postgres;
